...
?>
<a href="<?= base_url('masyarakat/form_aduan') ?>" class="btn btn-sm-7 btn-success mt-3">Buat Pengaduan</a>
...
<div class="row row-cols-1 row-cols-md-3 g-4 pt-5">
  ...
  <a href="' . base_url('masyarakat/tanggapan/') . $data['id_pengaduan'] . '" class="btn btn-sm btn-success float-end">Tanggapan</a>
</div>
    </div>
  </div>
